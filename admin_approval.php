...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["action"])) {
    ...
    if ($action == "approve") {
        ...
        $sql = "INSERT INTO approved_events (eventTitle, eventDate, eventTime, eventLocation, eventDescription, eventCategory, eventImage, eventOrganizer, eventContact)
        VALUES ('$event_data['eventTitle']', '$event_data['eventDate']', '$event_data['eventTime']', '$event_data['eventLocation']', '$event_data['eventDescription']', '$event_data['eventCategory']', '$event_data['eventImage']', '$event_data['eventOrganizer']', '$event_data['eventContact'])";
        $conn->query($sql);
