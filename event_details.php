...
switch ($action) {
  case "details":
    ...
    $sql = "SELECT * FROM pending_events WHERE id = '$eventID'";
  ...
  case "approve":
    ...
    if ($conn->error) {
      ...
      SELECT eventTitle, eventDate, eventTime, eventLocation, eventDescription, eventCategory, eventImage, eventOrganizer, eventContact FROM pending_events WHERE id = '$eventID'";
      $conn->query($sql);
