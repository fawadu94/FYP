...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO pending_events (eventTitle, eventDate, eventTime, eventLocation, eventDescription, eventCategory, eventImage) VALUES ('$eventTitle', '$eventDate', '$eventTime', '$eventLocation', '$eventDescription', '$eventCategory', '$eventImage')";
